    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          // Legacy aliases
          plate: "hsl(var(--status-plate))",
          printing: "hsl(var(--status-printing))",
          cutting: "hsl(var(--status-cutting))",
          dispatch: "hsl(var(--status-dispatch))",
        },
        source: {
          whatsapp: "hsl(var(--source-whatsapp))",
